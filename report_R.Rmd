...
\begin{table}[h] 
  ...
  \begin{tabular}{p{3cm}p{8cm}p{8cm}}
      ...
      \hline
      \verb|`r py$story1_date`| &  \verb|`r py$story1_short`| & \href{`r py$story1_link`}{link} \\
      \verb|`r py$story2_date`| & \verb|`r py$story2_short`| & \href{`r py$story2_link`}{link} \\
      \verb|`r py$story3_date`| & \verb|`r py$story3_short`| & \href{`r py$story3_link`}{link} \\
      \verb|`r py$story4_date`| & \verb|`r py$story4_short`| & \href{`r py$story4_link`}{link} \\
      \verb|`r py$story5_date`| & \verb|`r py$story5_short`| & \href{`r py$story5_link`}{link} \\
      \hline
  \end{tabular}
\end{table}
-->
